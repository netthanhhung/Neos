<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActionDetails.aspx.cs" Inherits="ActionDetails" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function disableCreatedDatePicker()
        {
            var picker = $find("<%= datCreationDate.ClientID %>");
            if(picker != null)
...
<body onbeforeunload="onform_unload()" onload="disableCreatedDatePicker()">
    ...
    <div class="rightpane_title" style="width:100%">
        <table style="width:98%">
            <tr>                                   
                <td>
                    <asp:Literal runat="server" ID="lblActionDetailTitle" Text="Action Details"></asp:Literal>
                </td>
                <td align="right">
            ...
            <tr>
                ...
                <td>
                    ...
                    <telerik:RadDateTimePicker ID="datHour" runat="server" Width="167px"  Skin="Office2007"
                     Calendar-Visible="false" DateInput-DisplayDateFormat="hh:mm tt"  >                        
