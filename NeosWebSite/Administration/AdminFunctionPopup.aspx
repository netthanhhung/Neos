<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminFunctionPopup.aspx.cs" Inherits="AdminFunctionPopup" %>
...
<head runat="server">
    <title>Add/Edit function page</title>
...
<body>
    <form id="addEditFunctionForm" runat="server">
    <telerik:RadScriptManager ID="ScriptManager" runat="server" /> 
    <div>
        <table>
            <tr>
                <td style="width:120px">
                    <asp:Label ID="lblFunctionFam" runat="server" Text="Function category"></asp:Label>
                </td>
                <td style="width:200px">
                    <telerik:RadComboBox ID="ddlFunctionFam" runat="server" Width="204px" Height="150px" Skin="Office2007" />
                </td>                
            </tr>
            <tr>
                <td valign="top">
