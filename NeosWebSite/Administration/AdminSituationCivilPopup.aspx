<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminSituationCivilPopup.aspx.cs" Inherits="AdminSituationCivilPopup" %>
...
<head runat="server">
    <title>Add/Edit civil situation page</title>
...
<body>
    <form id="addEditSituationCivilForm" runat="server">
        ...
        <table>
            <tr>
                ...
                <td style="width:200px">
                    <telerik:RadTextBox ID="txtCode" runat="server" Width="200px" MaxLength="3"></telerik:RadTextBox>
                </td>                
            </tr>
            <tr>
                <td valign="top">
                ...
                <td>
                    <telerik:RadTextBox ID="txtCodeType" runat="server" Width="200px" MaxLength="25"></telerik:RadTextBox>
                </td>                
            </tr>
            <tr>
                <td valign="top">
