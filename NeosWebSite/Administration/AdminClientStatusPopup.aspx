<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminClientStatusPopup.aspx.cs" Inherits="AdminClientStatusPopup" %>
...
<head runat="server">
    <title>Add/Edit client status page</title>
...
<body>
    <form id="addEditClientStatusForm" runat="server">
    <telerik:RadScriptManager ID="ScriptManager" runat="server" /> 
    <div>
        <table>
            <tr>
                <td style="width:130px">
                    <asp:Label ID="lblClientStatus" runat="server" Text="Status"></asp:Label>
                </td>
                <td style="width:200px">
                    <telerik:RadTextBox ID="txtClientStatus" runat="server" Width="200px" MaxLength="50"></telerik:RadTextBox>
                </td>                
            </tr>                  
        </table>
