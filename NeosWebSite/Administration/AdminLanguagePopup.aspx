<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminLanguagePopup.aspx.cs" Inherits="AdminLanguagePopup" %>
...
<head runat="server">
    <title>Add/Edit language page</title>
...
<body>
    <form id="addEditLanguageForm" runat="server">
    <telerik:RadScriptManager ID="ScriptManager" runat="server" /> 
    <div>
        <table>
            <tr>
                <td style="width:130px">
                    <asp:Label ID="lblLanguageID" runat="server" Text="Language ID"></asp:Label>
                </td>
                <td style="width:200px">
                    <telerik:RadTextBox ID="txtLanguageID" runat="server" Width="200px" MaxLength="25"></telerik:RadTextBox>
                </td>                
            </tr>
            <tr>
                <td valign="top">
                ...
                <td>
                    <telerik:RadTextBox ID="txtLabel" runat="server" Width="200px" MaxLength="25"></telerik:RadTextBox>
                </td>                
            </tr>            
        </table>
