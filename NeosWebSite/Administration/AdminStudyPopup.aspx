<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminStudyPopup.aspx.cs" Inherits="AdminStudyPopup" %>
...
<head runat="server">
    <title>Add/Edit study page</title>
...
<body>
    <form id="addEditStudyForm" runat="server">
    <telerik:RadScriptManager ID="ScriptManager" runat="server" /> 
    <div>
        <table>
            <tr>
                <td style="width:130px">
                    <asp:Label ID="lblStudyLabel" runat="server" Text="Study"></asp:Label>
                </td>
                <td style="width:200px">
                    <telerik:RadTextBox ID="txtStudyLabel" runat="server" Width="200px" MaxLength="50"></telerik:RadTextBox>
                </td>                
            </tr>                  
        </table>
