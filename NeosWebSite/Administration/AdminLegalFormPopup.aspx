<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminLegalFormPopup.aspx.cs" Inherits="AdminLegalFormPopup" %>
...
<head runat="server">
    <title>Add/Edit legal form page</title>
...
<body>
    <form id="addEditLegalFormForm" runat="server">
    <telerik:RadScriptManager ID="ScriptManager" runat="server" /> 
    <div>
        <table>
            <tr>
                <td style="width:130px">
                    <asp:Label ID="lblFormID" runat="server" Text="Form ID"></asp:Label>
                </td>
                <td style="width:200px">
                    <telerik:RadTextBox ID="txtFormID" runat="server" Width="200px" MaxLength="35"></telerik:RadTextBox>
                </td>                
            </tr>                  
        </table>
