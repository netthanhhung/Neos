        ...
        <%--<asp:RegularExpressionValidator runat="server" ID="test"></asp:RegularExpressionValidator>--%>
            <table width="100%">
                ...
                <tr>
                    ...
                    <td style="">
                        <asp:Repeater runat="server" ID="rptAttachInvoices" OnItemDataBound="OnRepeaterAttachInvoices_ItemDataBound">
                            <ItemTemplate>
                                <asp:CheckBox runat="server" ID="chkSelectInvoice" ForeColor="#0000EE" Font-Italic="true" Checked="true"  />
                            </ItemTemplate>
                        </asp:Repeater>
                    </td>
                </tr>
